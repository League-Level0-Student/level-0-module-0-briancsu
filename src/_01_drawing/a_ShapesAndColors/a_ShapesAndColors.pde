...
fill(#FFFFFF);
ellipse(385, 345, 130, 130);
ellipse(388, 498, 175, 175);
ellipse(391, 696, 220, 220);

fill(#050505);
ellipse(388, 460, 10, 10);
ellipse(388, 500, 10, 10);
ellipse(388, 540, 10, 10);

ellipse(365, 325, 7, 7);
ellipse(411, 325, 7, 7);

fill(#FCAD0D);
triangle(380, 350, 390, 375, 398, 350);
